...
public final class ModBlockEntities {
  ...
  public static final RegistryObject<BlockEntityType<PortalBlockEntity>> PORTAL_BE = BLOCK_ENTITY_REGISTER.register("portal_block_entity", () -> BlockEntityType.Builder.of(PortalBlockEntity::new, ModBlocks.PORTAL_BLOCK.get()).build(null));
