...
public final class ModBlockEntities {
  ...
  public static final RegistryObject<BlockEntityType<PortalControllerBlockEntity>> PORTAL_BE = BLOCK_ENTITY_REGISTER.register("portal_block_entity", () -> BlockEntityType.Builder.of(PortalControllerBlockEntity::new, ModBlocks.PORTAL_BLOCK.get()).build(null));
