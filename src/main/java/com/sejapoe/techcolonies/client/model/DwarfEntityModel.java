...
public class DwarfEntityModel extends EntityModel<DwarfEntity> implements ArmedModel {
  ...
  @Override
  public void setupAnim(@NotNull DwarfEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
  ...
  @Override
  public void prepareMobModel(@NotNull DwarfEntity entity, float limbSwing, float limbSwingAmount, float partialTick) {
